...
from .serializers import (
    ...
    InfosPieceSerializer,MantenanceSendSerializer)
...
class CreateMantenancesView(generics.ListCreateAPIView):
    queryset = Mantenances.objects.all()
    serializer_class = MantenanceSendSerializer
    permission_classes = [permissions.IsAdminUser]
create_MaintenanceView = ListCreateMantenancesView.as_view()
