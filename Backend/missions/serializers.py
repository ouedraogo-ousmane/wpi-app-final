...
class ChauffeursSerializer(serializers.ModelSerializer):
    ...
    def get_vehiculeInfos(self, obj):
        ...
        return Vehicules.objects.filter(pk=obj.vehicule_id).values("id","immat","marque","categorie","couleur","poids_vide","est_disponible")[0]
...
class InfosRecetteCoutUnitaire(serializers.ModelSerializer):
    '''
        info sur les cout d'une recette en fonction de 
        son client, du produit, mission
    '''
    class Meta:
        model = Recettes
        fields=(
