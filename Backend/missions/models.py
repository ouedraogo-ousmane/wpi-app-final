...
class Vehicules(models.Model):
    ...
    poids_vide = models.DecimalField(max_digits=10, decimal_places=2)
...
class Recettes(models.Model):
    ...
    cout_unitaire = models.DecimalField(max_digits=10, decimal_places=2, default=0.0)
...
class RecetteDetailPesage(models.Model):
    ...
    premier_pese = models.DecimalField(max_digits=10, decimal_places=2, default=0.0)
    deuxieme_pese = models.DecimalField(max_digits=10, decimal_places=2, default=0.0)
    date_creation = models.DateTimeField(auto_now_add=True)
